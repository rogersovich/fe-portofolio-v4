<template>
  <div>
    <div class="mb-6">
      <div class="text-3xl font-rethink font-bold">Page Project</div>
      <div class="text-muted-foreground font-light mt-2">
        Create & List Project in here
      </div>
    </div>
    <div>
      <DataTable
      ...
      >
        <template #header>
          <div class="flex flex-wrap items-center justify-between gap-2">
            <span class="text-lg font-bold">List Project</span>
        ...
        >
          <template #body="{ data }">
            <NuxtImg
              :src="MINIO_BASE_URL + data.image_file_name"
              fit="cover"
        ...
        >
          <template #body="{ data }">
            <div class="flex items-center justify-center gap-4">
              <NuxtLink
                :to="`/adminz/project/edit/${data.id}`"
...
const setFilters = (params: TBaseParamsProject) => {
...
const handleAPIFetchProjects = async () => {
  let params = {
    page: paginate.page + 1,
    limit: paginate.limit,
    sort: sorts.sort,
    order: sorts.order,
  } as TBaseParamsProject;
